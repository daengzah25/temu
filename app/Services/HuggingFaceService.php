...
class HuggingFaceService
{
    ...
    public function __construct()
    {
        ...
        // Pakai Router Chat Completions (OpenAI-style)
    ...
    public function generatePromotion($data)
    {
        ...
        try {
            ...
            // Handle error spesifik (optional)
            if ($response->status() === 503) {
                return [
                    'success' => false,
                    'error' => 'Model sedang loading. Tunggu beberapa detik dan coba lagi.',
                ];
            }
            ...
            if ($response->status() === 404) {
                return [
                    'success' => false,
                    'error' => 'Model tidak ditemukan (404). Periksa HUGGINGFACE_MODEL di .env.',
                ];
            }
            ...
            // Format response Router (Chat Completions)
            // {
            //   "choices": [
            //     {
            //       "message": {
